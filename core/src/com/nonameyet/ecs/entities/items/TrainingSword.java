...
public class TrainingSword extends ItemEntity {

    public TrainingSword(ECSEngine ecsEngine, Vector2 spawnLocation) {
    ...
    void textureComponent() {
        textureAtlas = Assets.manager.get(AssetName.SWORD_ATLAS.getAssetName());
