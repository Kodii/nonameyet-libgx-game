...
public class AnimationSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        SubAnimationComponent subAnimation = subAnimationCmpMapper.get(entity);
        ...
        // sub animation
        if (subAnimation != null && subAnimation.animations.containsKey(state.get())) {
            SubTextureComponent subTexture = subTextureCmpMapper.get(entity);
            subTexture.region = (TextureRegion) subAnimation.animations.get(state.get()).getKeyFrame(state.time, state.isLooping);
        }
