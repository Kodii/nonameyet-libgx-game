...
public class LightSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        Gdx.app.debug("render: ", String.valueOf(lightState.get()));
        ...
        if (lightState.get() == LightStateComponent.STATE__ON && b2dlight.flDistance > 0) {
            ...
            Gdx.app.debug("light render: ", String.valueOf((b2dlight.distance + MathUtils.sin(b2dlight.flTime) * b2dlight.flDistance)));
